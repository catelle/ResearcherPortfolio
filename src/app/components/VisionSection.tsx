  ...
  return (
    <section id="vision" className="relative py-32 bg-background">
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="relative p-12 rounded-3xl bg-card border-2 border-[#a855f7]/30 shadow-lg">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {vision.pillars.map((pillar, index) => {
            ...
            <motion.div
              ...
              className="group"
            >
              <div className="h-full p-6 rounded-2xl bg-card border border-border hover:border-[#a855f7]/50 transition-all duration-300 shadow-sm text-center">
                <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-[#a855f7] flex items-center justify-center">
